                ...
                <div class="plan-item">
                    ...
                    <div class="plan-bottom">
                        ...
                        <div class="plan-body">
                            ...
                            <ul class="plan-info">
                                <li class="active"><i  class="las la-business-time __plan_info " data="bv"></i>@lang('Points Volume: '){{ __(@$plan->bv) }}</li>
        ...
        (function($){
            $('.__plan_info').on('click', function (e) {
               ...
               if(data=='bv'){
                ...
                modal.find('#__modal_title').html("@lang('Points Volume (PV) info')")
